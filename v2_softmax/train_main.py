...
chkfilename = "model_checkpoit_weights_only" \
...
def train(model,initial_epoch=1,batch_size = 16,
    ...
    img_for_view,_ = X_train[0]
    write_images_tb(img_for_view)

    #fire...
    history = model.fit(X_train,
                  validation_data=X_train,validation_steps=10,
...
if __name__ == "__main__":
    ...
    model = load_model()
    history = train(model,initial_epoch=1,epoch_num=10)
