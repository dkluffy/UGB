...
img_dir = run_logdir+"/targets/"
tg_imgs = ['1.0.jpeg', '2.0.jpeg', '3.0.jpeg', '4.0.jpeg', '5.0.jpeg', '6.0.jpeg', '7.0.jpeg', '8.0.jpeg']
tg_imgs = [img_dir+im for im in tg_imgs]
val_imgs = ["1000.png"]
val_imgs = [img_dir+im for im in val_imgs]
tg_labels = [1]*len(tg_imgs)
val_labels = [0]*len(val_imgs)
...
train(X_train,X_val,101)

cd /content/drive/My\ Drive

!ls

!tar czf chk.colab.150epoch.tar.gz ckpt-31.* checkpoint
